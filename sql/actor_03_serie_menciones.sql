-- =====================================================
-- Dashboard por Actor - Query 3
-- SERIE TEMPORAL: Menciones Totales por Tiempo
...
--
-- Uso en Dashboard:
--   - Colocar en sección de series temporales
--   - Conectar a filtros globales: actor, fecha, source_name
--   - Permite ver tendencias de menciones a lo largo del tiempo
-- =====================================================
